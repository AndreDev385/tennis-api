...
import type { IAds, IClub } from "../../types/interfaces";
...
const Ads = () => {
			...
			<tr key={item.adId}>
				...
				<td className="text-center">
					{clubs.filter((club) => club.clubId === item.clubId)[0]
						? clubs.filter((club) => club.clubId === item.clubId)[0].name
						: "-"}
				</td>
				<td className="text-center">
	...
	return (
		<>
			...
			{showModalCreate && (
				<CreateAds clubs={clubs} dismiss={handleDismissCreate} />
			)}
		</>
	);
};
