...
const AdvancedTable = ({tracker, mode, playerVsPlayer}: IPropsTable) => {
  return (
    <> 
      ...
      <Games tracker={tracker}  mode={mode} playerVsPlayer={playerVsPlayer}/>
      <BallInGame tracker={tracker} mode={mode} playerVsPlayer={playerVsPlayer}/>
      <Rally tracker={tracker} mode={mode} playerVsPlayer={playerVsPlayer}/>
    </>
  )
}
