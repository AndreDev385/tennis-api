...
export function buildStandardSections(stats: TournamentMatchTracker): Section[] {
	...
	const t1ServicesDone =
		t1FirstServIn() + t1SecondServIn() + t1DoubleFaults();
	const t2ServicesDone =
		t2FirstServIn() + t2SecondServIn() + t2DoubleFaults();

	return [
		{
			title: "Servicio", stats: [
				{
					name: "Aces",
					firstValue: `${t1Aces()}`,
					secondValue: `${t2Aces()}`,
				...
				},
				{
					...
					percentage1: calculatePercentage(
						t1PointsWinnedFirstServ(), t1FirstServIn()),
					percentage2: calculatePercentage(
						t2PointsWinnedFirstServ(), t2FirstServIn()),
				},
				{
					...
					percentage1: calculatePercentage(
						t1SecondServIn(), t1SecondServIn() + t1DoubleFaults()),
					percentage2: calculatePercentage(
						t2SecondServIn(), t2SecondServIn() + t2DoubleFaults()),
				},
				{
				...
				},
				{
					...
					percentage1: calculatePercentage(
						t1PointsWinnedSecondServ(), t1SecondServIn()),
					percentage2: calculatePercentage(
						t2PointsWinnedSecondServ(), t2SecondServIn()),
				},
				{
			...
			stats: [
				{
					...
					percentage1: calculatePercentage(t1FirstReturnIn(),
						t1FirstReturnIn() + t1FirstReturnOut()),
					percentage2: calculatePercentage(t2FirstReturnIn(),
				...
				},
				{
					...
					percentage1: calculatePercentage(t1PointsWinnedFirstReturn(),
						t1FirstReturnIn() + t1FirstReturnOut()),
					percentage2: calculatePercentage(t2PointsWinnedFirstReturn(),
						t2FirstReturnIn() + t2FirstReturnOut()),
				},
				{
					...
					percentage1: calculatePercentage(t1SecondReturnIn(),
						t1SecondReturnIn() + t1SecondReturnOut()),
					percentage2: calculatePercentage(t2SecondReturnIn(),
				...
				},
				{
					...
					percentage1: calculatePercentage(t1PointsWinnedSecondReturn(),
						t1SecondReturnIn() + t1SecondReturnOut()),
					percentage2: calculatePercentage(t2PointsWinnedSecondReturn(),
						t2SecondReturnIn() + t2SecondReturnOut()),
				},
				{
					name: "Break point",
			...
			title: "Pelota en Juego", stats: [
				{
					...
					percentage1: calculatePercentage(t1MeshPointsWon(),
						t1MeshPointsWon() + t1MeshPointsLost()),
					percentage2: calculatePercentage(t2MeshPointsWon(),
				...
				},
				{
					...
					percentage1: calculatePercentage(t1BckgPointsWon(),
						t1BckgPointsWon() + t1BckgPointsLost()),
					percentage2: calculatePercentage(t2BckgPointsWon(),
			...
			title: "Puntos", stats: [
				{
					...
					percentage1: calculatePercentage(t1ShortRallyWon(),
						t1ShortRallyWon() + t1ShortRallyLost()),
					percentage2: calculatePercentage(t2ShortRallyWon(),
				...
				},
				{
					...
					percentage1: calculatePercentage(t1MediumRallyWon(),
						t1MediumRallyWon() + t1MediumRallyLost()),
					percentage2: calculatePercentage(t2MediumRallyWon(),
				...
				},
				{
					...
					percentage1: calculatePercentage(
						t1LongRallyWon(), t1LongRallyWon() + t1LongRallyLost()),
					percentage2: calculatePercentage(
						t2LongRallyWon(), t2LongRallyWon() + t2LongRallyLost()),
				},
			]
		},
	]
