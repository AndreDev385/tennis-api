...
import type { ISeason } from "../../types/interfaces";
...
const Seasons = () => {
	...
	const onClickEndSeason = (item: ISeason): void => {
		setModalQuestion(
			`¿Estás seguro que quieres finalizar temporada ${item.name}?`,
		);
					...
					<Table responsive="sm">
						<thead>
							<tr>
								<th>Nombre</th>
								<th>Estatus</th>
								<th className="text-center">Manejar temporada</th>
							</tr>
						</thead>
