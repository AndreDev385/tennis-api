...
export class BracketPlace extends ValueObject<BracketPlaceProps> {
	...
	setInscribed(p: Participant | null, c: Couple | null, t: ContestTeam | null) {
		this.props.participant = p;
		this.props.couple = c;
		this.props.contestTeam = t;
	}
...
export class BracketNode extends Entity<BracketNodeProps> {
	...
	public setRightPlace(place: BracketPlace) {
		this.props.rightPlace = place;
	}

	public setLeftPlace(place: BracketPlace) {
		this.props.leftPlace = place;
	}
