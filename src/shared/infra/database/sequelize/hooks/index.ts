...
(async function createHooksForAggregateRoots() {
    const { UserModel, MatchModel, ClashModel, SeasonModel, PlayerModel } = models;
    ...
    MatchModel.addHook("afterBulkUpdate", (m: any) => dispatchEventsCallback(m.attributes, "matchId"));
    ...
    ClashModel.addHook("afterBulkUpdate", (m: any) => dispatchEventsCallback(m.attributes, "clashId"));
    ...
    UserModel.addHook("afterBulkUpdate", (m: any) => dispatchEventsCallback(m.attributes, "userId"));
    ...
    SeasonModel.addHook("afterBulkUpdate", (m: any) => dispatchEventsCallback(m.attributes, "seasonId"));

    PlayerModel.addHook('afterCreate', (m: any) => dispatchEventsCallback(m, 'playerId'));
    PlayerModel.addHook('afterDestroy', (m: any) => dispatchEventsCallback(m, 'playerId'));
    PlayerModel.addHook('afterUpdate', (m: any) => dispatchEventsCallback(m, 'playerId'));
    PlayerModel.addHook('afterSave', (m: any) => dispatchEventsCallback(m, 'playerId'));
    PlayerModel.addHook('afterUpsert', (m: any) => dispatchEventsCallback(m, 'playerId'));
    PlayerModel.addHook("afterBulkUpdate", (m: any) => dispatchEventsCallback(m.attributes, "playerId"));
